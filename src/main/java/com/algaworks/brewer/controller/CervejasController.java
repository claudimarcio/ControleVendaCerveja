...
import com.algawoks.brewer.model.Origem;
import com.algawoks.brewer.model.Sabor;
import com.algawoks.brewer.repository.Estilos;
	...
	public ModelAndView cadastrar(@Valid Cerveja cerveja, BindingResult result, Model model, RedirectAttributes atributes) {
		...
		//Salvar no banco de dados
	     	...
	     	cadastroCervejaService.salvar(cerveja);      
	     	 atributes.addFlashAttribute("mensagem", "Cadastrado com sucesso");
